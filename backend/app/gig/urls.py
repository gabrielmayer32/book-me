...
from .views import BookGigView, CancelBookingView, CreateGigView, GigDetailView, GigInstancesView, GigUpdateAPIView, ProviderGigsView, ProviderUpcomingGigsView, UpcomingGigsView, UserBookingsView, AcceptBookingView, BookingRequestsView, DeclineBookingView
urlpatterns = [
