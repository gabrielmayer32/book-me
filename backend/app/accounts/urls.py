...
from .views import ActivityCollaboratorsView, ActivityList, DeleteNotificationView, MarkNotificationsAsReadView, NotificationsAPIView, login_view, receive_expo_push_token, service_providers_list
from . import views
